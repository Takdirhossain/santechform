...
import { SliderIndividual } from "../components/Slider";
...
useEffect(() => {
  ...
  return (
    <div>
     <SliderIndividual/>
      ...
      <div id="about" class="etiquetas">
        ...
        <div class="etiqueta-item">
         ...
         <p class="etiquetas-info"><Number n={1250}/></p>
        ...
        <div class="etiqueta-item">
         <div className="flex items-center">
         <p class="etiquetas-info"><Number n={400}/></p>
         <p className="text-6xl text-[#2c4a9a]">+</p>
         </div>
     ...
     <Link to="aboutus"> <button className="btn mt-8">Learn More</button></Link>
     </div>
     </div>
      ...
      <section id="services" class="services-section">
        ...
        <section class="services">
          <div data-aos="zoom-out-right" onClick={() => handaleservice(1)} class="service-item service1">
            <div class="img">
          ...
          <div data-aos="zoom-out-right" onClick={() => handaleservice(2)}  class="service-item service2">
            <div class="img">
          ...
          <div data-aos="zoom-out-right" onClick={() => handaleservice(3)} class="service-item service4">
            <div class="img">
          ...
          <div  data-aos="zoom-out-right" onClick={() => handaleservice(4)}  class="service-item service5">
            <div class="img">
          ...
          <div  data-aos="zoom-out-right" onClick={() => handaleservice(5)}  class="service-item service6">
            <div class="img">
          ...
          {/* <div data-aos="zoom-out-right" onClick={() => handaleservice(6)}   class="service-item service3">
            <div class="img">
          ...
          <div data-aos="zoom-out-right" onClick={() => handaleservice(7)} class="service-item service7">
            <div class="img">
