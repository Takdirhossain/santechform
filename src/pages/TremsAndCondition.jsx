    ...
    return (
        <div className="">
          ...
          <Nav/>
            ...
            <main  class="wrap">
        <section data-aos="zoom-out" class="trams">
          <div  class="container__heading">
            <h2 className="font-bold text-3xl text-green-600 mt-6">Terms & Conditions</h2>
          </div>
          <div class="container__content">
            <p>Welcome to Letusmaintain!
      These terms and conditions outline the rules and regulations for the use of KSK 's Website, located at www.letusmaintain.com .
      
      By accessing this website we assume you accept these terms and conditions. Do not continue to use Letusmaintain if you do not agree to take all of the terms and conditions stated on this page.
      ...
      The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the person log on this website and compliant to the Company's terms and conditions. "The Company", "Ourselves", "We", "Our" and "Us", refers to our Company. "Party", "Parties", or "Us", refers to both the Client and ourselves. All terms refer to the offer, acceptance and consideration of payment necessary to undertake the process of our assistance to the Client in the most appropriate manner for the express purpose of meeting the Client's needs in respect of provision of the Company's stated services, in accordance with and subject to, prevailing law of in. Any use of the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same. </p> <br/>
            <h2 className="font-bold text-3xl text-green-600 mt-6">Cookies</h2>
            
            <p>We employ the use of cookies. By accessing Letusmaintain, you agreed to use cookies in agreement with the KSK 's Privacy Policy.
      Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies. </p> <br />
            <h2 className="font-bold text-3xl text-green-600 mt-6">License</h2>
            <p> Unless otherwise stated, KSK and/or its licensors own the intellectual
        ...
        conditions.</p> <br />
        <h2 className="font-bold text-3xl text-green-600 mt-6">You must not:</h2>
        <ul>
       ...
       This Agreement shall begin on the date hereof. Our Terms and
          ...
          of the Comments on this website. <br />
...
<ul>
       ...
       <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of KSK ; and (d) the link is in the context of general resource information.

These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of the linking party and its products or services; and (c) fits within the context of the linking party's site.

If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to KSK . Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.</p>
<p>
...
<h2 className="font-bold text-3xl text-green-600 mt-6">iFrames</h2>
...
<h2 className="font-bold text-3xl text-green-600 mt-6">Content Liability

</h2>
<p>We shall not be hold responsible for any content that appears on your Website. You agree to protect and defend us against all claims that is rising on your Website. No link(s) should appear on any Website that may be interpreted as libelous, obscene or criminal, or which infringes, otherwise violates, or advocates the infringement or other violation of, any third party rights.

</p>
<h2 className="font-bold text-3xl text-green-600 mt-6">Reservation of Rights

</h2>
<p>We reserve the right to request that you remove all links or any particular link to our Website. You approve to immediately remove all links to our Website upon request. We also reserve the right to amen these terms and conditions and it's linking policy at any time. By continuously linking to our Website, you agree to be bound to and follow these linking terms and conditions.

</p>
<h2 className="font-bold text-3xl text-green-600 mt-6">Removal of links from our website
...
<h2 className="font-bold text-3xl text-green-600 mt-6">Disclaimer</h2>
