...
const Contact = () => {
    return (
        ...
        <div class="bg-[#293f75] text-gray-100 py-32">
              ...
              <div
                ...
                <div class="">
                  ...
                  <div class="mt-8">
                    <button
                      class="uppercase text-sm font-bold tracking-wide bg-[#50dec8] text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                      Send Message
                    </button>
                  </div>
                </div>
